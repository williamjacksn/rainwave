...
class WebListPowerHours(api.web.PrettyPrintAPIHandler, power_hours.ListPowerHours):
...
class WebPowerHourDetail(api.web.PrettyPrintAPIHandler, power_hours.GetPowerHour):
